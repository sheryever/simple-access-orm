...
System.Object<br />&nbsp;&nbsp;System.Attribute<br />&nbsp;&nbsp;&nbsp;&nbsp;SimpleAccess.DbColumnAttribute<br />
...
**C++**<br />
``` C++
public ref class DbColumnAttribute : public Attribute
```

**F#**<br />
``` F#
type DbColumnAttribute =  
    class
        inherit Attribute
    end
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_SimpleAccess_DbColumnAttribute__ctor">DbColumnAttribute</a></td><td>
Initialize the attribute.</td></tr></table>&nbsp;
<a href="#dbcolumnattribute-class">Back to Top</a>
