...
#### Implements
<a href="M_SimpleAccess_Core_ISimpleAccess_6_ExecuteDynamics_7">ISimpleAccess(TDbConnection, TDbTransaction, TDbCommand, TDataParameter, TDbDataReader, TParameterBuilder).ExecuteDynamics(TDbTransaction, String, String, TDataParameter[])</a><br />
