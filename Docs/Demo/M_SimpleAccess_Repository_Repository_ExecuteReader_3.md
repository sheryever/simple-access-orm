...
#### Implements
<a href="M_SimpleAccess_Repository_IRepository_ExecuteReader_3">IRepository.ExecuteReader(String, CommandType, String, Dictionary(String, PropertyInfo), Object)</a><br />
