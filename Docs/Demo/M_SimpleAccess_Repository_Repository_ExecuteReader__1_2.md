# Repository.ExecuteReader(*TEntity*) Method (String, CommandType, String, Dictionary(String, PropertyInfo), SqlParameter[])
...
#### Implements
<a href="M_SimpleAccess_Repository_IRepository_ExecuteReader__1_2">IRepository.ExecuteReader(TEntity)(String, CommandType, String, Dictionary(String, PropertyInfo), SqlParameter[])</a><br />
