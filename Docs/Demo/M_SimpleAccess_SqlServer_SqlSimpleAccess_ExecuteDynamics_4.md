# SqlSimpleAccess.ExecuteDynamics Method (String, CommandType, String, SqlParameter[])
...
#### Implements
<a href="M_SimpleAccess_Core_ISimpleAccess_6_ExecuteDynamics_1">ISimpleAccess(TDbConnection, TDbTransaction, TDbCommand, TDataParameter, TDbDataReader, TParameterBuilder).ExecuteDynamics(String, CommandType, String, TDataParameter[])</a><br />
