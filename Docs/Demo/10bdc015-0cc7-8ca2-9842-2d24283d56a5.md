...
#### Implements
<a href="c1a933d0-99d7-ebca-3bd2-13fd91cc0ae9">ISimpleAccess(TDbConnection, TDbTransaction, TDbCommand, TDataParameter, TDbDataReader, TParameterBuilder).ExecuteEntity(TEntity)(String, CommandType, String, Dictionary(String, PropertyInfo), Object)</a><br />
