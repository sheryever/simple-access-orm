...
#### Implements
<a href="M_SimpleAccess_Repository_IRepository_ExecuteReaderSingle__1_2">IRepository.ExecuteReaderSingle(TEntity)(String, CommandType, String, Dictionary(String, PropertyInfo), SqlParameter[])</a><br />
