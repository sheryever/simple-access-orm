# SqlSimpleAccess.ExecuteEntities(*TEntity*) Method (String, CommandType, String, Dictionary(String, PropertyInfo), SqlParameter[])
...
#### Implements
<a href="M_SimpleAccess_Core_ISimpleAccess_6_ExecuteEntities__1_1">ISimpleAccess(TDbConnection, TDbTransaction, TDbCommand, TDataParameter, TDbDataReader, TParameterBuilder).ExecuteEntities(TEntity)(String, CommandType, String, Dictionary(String, PropertyInfo), TDataParameter[])</a><br />
