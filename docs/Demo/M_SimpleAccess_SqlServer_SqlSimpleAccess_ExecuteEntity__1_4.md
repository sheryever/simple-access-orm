# SqlSimpleAccess.ExecuteEntity(*TEntity*) Method (String, CommandType, String, Dictionary(String, PropertyInfo), SqlParameter[])
...
#### Implements
<a href="M_SimpleAccess_Core_ISimpleAccess_6_ExecuteEntity__1_1">ISimpleAccess(TDbConnection, TDbTransaction, TDbCommand, TDataParameter, TDbDataReader, TParameterBuilder).ExecuteEntity(TEntity)(String, CommandType, String, Dictionary(String, PropertyInfo), TDataParameter[])</a><br />
