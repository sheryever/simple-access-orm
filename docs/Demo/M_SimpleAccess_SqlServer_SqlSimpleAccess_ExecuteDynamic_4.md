...
#### Implements
<a href="M_SimpleAccess_Core_ISimpleAccess_6_ExecuteDynamic_1">ISimpleAccess(TDbConnection, TDbTransaction, TDbCommand, TDataParameter, TDbDataReader, TParameterBuilder).ExecuteDynamic(String, CommandType, String, TDataParameter[])</a><br />
