...
#### Implements
<a href="5d7015d0-08de-3d9c-c0e9-d7f06b5eab1b">ISimpleAccess(TDbConnection, TDbTransaction, TDbCommand, TDataParameter, TDbDataReader, TParameterBuilder).ExecuteDynamics(TDbTransaction, String, CommandType, String, TDataParameter[])</a><br />
