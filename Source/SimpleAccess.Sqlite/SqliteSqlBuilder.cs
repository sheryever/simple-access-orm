...
namespace SimpleAccess.SQLite
{
    ...
    public class SQLiteSqlBuilder : ISqlBuilder<SQLiteParameter>
    {
        ...
        private EntityParameters<SQLiteParameter> EntityInsertParameters { get; set; }
        ...
        /// <returns></returns>
        public EntityParameters<SQLiteParameter> CreateEntityParameters(object entity, bool checkForIdentityColumn)
        {

            var entityParameters = EntityParameters<SQLiteParameter>.Create(entity, (o, dataParameters, outParamsDictionary, checkForIdentity) =>
            {
        ...
        /// <returns></returns>
        public void CreateDataParameter(PropertyInfo propertyInfo, IDictionary<PropertyInfo, SQLiteParameter> dataParameters, IDictionary<PropertyInfo, SQLiteParameter> outParamsDictionary, bool checkForIdentity)
        {
