...
using SimpleAccessNetCore.SqlServer.ConsoleTest.Entities;
using System;
...
namespace SimpleAccessNetCore.SqlServer.ConsoleTest
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var conn = SimpleAccess.Core.SimpleAccessSettings.GetProperConnectionString("sqlDefaultConnection");
