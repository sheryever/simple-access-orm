...
namespace SimpleAccess.Core.Entity
{
        ...
        where TDbParameter : IDataParameter
    {
        ...
        {
            EntityType = type;
            EntityTypeInfo = type.GetTypeInfo();
        ...
        {
            var entityAttribute = EntityTypeInfo.GetCustomAttributes(true).FirstOrDefault(c => c is EntityAttribute);
            ...
            var storedProcedureNameKeywordAttribute = EntityTypeInfo.GetCustomAttributes(true).FirstOrDefault(c => c is StoredProcedureNameKeyWordAttribute);
