    ...
    public class MySqlRepository : IMySqlRepository, IDisposable
    {
            ...
            where TEntity : class, new()
        {
            ...
            return SimpleAccess.ExecuteEntity<TEntity>(commandText, CommandType.StoredProcedure
                    , fieldToSkip, parameters: new MySqlParameter("@whereClause", DynamicQuery.CreateDbParametersFormWhereExpression(expression, entityInfo)));
        }
            ...
            where TEntity : class, new()
        {
            ...
            return SimpleAccess.ExecuteEntities<TEntity>(commandText, CommandType.StoredProcedure
                , fieldToSkip, parameters: new MySqlParameter("@whereClause", DBNull.Value));
        ...
        /// 
        /// <returns> . </returns>
        public IEnumerable<TEntity> FindAll<TEntity>(MySqlTransaction transaction, string fieldToSkip = null)
            where TEntity : class, new()
        {
            var entityInfo = RepositorySetting.GetEntityInfo(typeof(TEntity));
