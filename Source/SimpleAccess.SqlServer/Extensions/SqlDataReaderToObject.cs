...
//#endif
        public static List<TType> DataReaderToObjectList2<TType>(this IDataReader reader, string fieldsToSkip = null
            ...
            where TType : new()
        {
            ...
            {
                var inst = new TType();
                DataReaderToObject2<TType>(reader, inst, fieldsToSkip, piList, piListBasedOnDbColumn);
                items.Add(inst);
            }
        ...
        public static TType DataReaderToObject2<TType>(this IDataReader reader, string fieldsToSkip = null
            , Dictionary<string, PropertyInfo> piList = null, Dictionary<string, PropertyInfo> piListBasedOnDbColumn = null)
            where TType : new()
        {
            ...
            if (reader.Read())
            {
                DataReaderToObject2<TType>(reader, item, fieldsToSkip, piList, piListBasedOnDbColumn);
            }
...
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//#endif
        public static void DataReaderToObject2<TEntity>(this IDataReader reader, TEntity instance, string fieldsToSkip = null
            , Dictionary<string, PropertyInfo> piList = null, Dictionary<string, PropertyInfo> piListBasedOnDbColumn = null)
        {
            if (reader.IsClosed)
