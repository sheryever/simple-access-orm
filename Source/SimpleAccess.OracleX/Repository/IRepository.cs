    ...
    **/
    public interface IRepository
    {
        ...
        **/
        ...
        <returns> . </returns>
        **/
        int Insert<TEntity>(OracleTransaction oracleTransaction, StoredProcedureParameters storedProcedureParameters)
            where TEntity : class;
        ...
        <returns> . </returns>
        **/
        int Insert<TEntity>(StoredProcedureParameters storedProcedureParameters, OracleTransaction oracleTransaction = null)
            where TEntity : class;
        ...
        **/
        ...
        <returns> Number of rows affected (integer) </returns>
        **/
        int Update<TEntity>(OracleTransaction oracleTransaction, StoredProcedureParameters storedProcedureParameters)
            where TEntity : class;
        ...
        **/
        ...
        <returns> Number of rows affected (integer) </returns>
        **/
        int Delete<TEntity>(long id, OracleTransaction oracleTransaction = null)
            where TEntity : IEntity;
        ...
        <returns> Number of rows affected (integer) </returns>
        **/
        int Delete<TEntity>(OracleTransaction oracleTransaction, params OracleParameter[] oracleParameters)
            where TEntity : IEntity;
        ...
        **/
        ...
        <returns> Number of rows affected (integer) </returns>
        **/
        int ExecuteNonQuery(OracleTransaction oracleTransaction, string sql
        ...
        **/
        ...
        <returns> The <T> value </returns>
        **/
        T ExecuteScalar<T>(OracleTransaction oracleTransaction, string sql
            , CommandType commandType = CommandType.StoredProcedure
            , params OracleParameter[] oracleParameters);
        ...
        <returns> The <T> value </returns>
        **/
        T ExecuteScalar<T>(OracleTransaction oracleTransaction, string sql, CommandType commandType = CommandType.StoredProcedure, dynamic paramObject = null);
        ...
        **/
        ...
        <returns> The <T> value </returns>
        **/
        List<TEntity> ExecuteReader<TEntity>(OracleTransaction oracleTransaction, string sql, CommandType commandType = CommandType.StoredProcedure,
        ...
        **/
        ...
        <returns> The value of the entity. </returns>
        **/
        TEntity ExecuteReaderSingle<TEntity>(OracleTransaction oracleTransaction, string sql, CommandType commandType,
                                             string fieldsToSkip = null, Dictionary<string, PropertyInfo> piList = null,
                                             params OracleParameter[] oracleParameters)
            where TEntity : class, new();
       ...
       **/
        ...
        <returns> A list of dynamic. </returns>
        **/
        IList<dynamic> ExecuteReader(OracleTransaction oracleTransaction, string sql, CommandType commandType = CommandType.StoredProcedure,
                                     string fieldsToSkip = null, Dictionary<string, PropertyInfo> piList = null,
                                     params OracleParameter[] oracleParameters);
        /**--------------------------------------------------------------------------------------------------
        <summary> Executes the reader operation. </summary>
        ...
        **/
        ...
        <returns> Result in a dynamic object. </returns>
        **/
        dynamic ExecuteReaderSingle(OracleTransaction oracleTransaction, string sql, CommandType commandType = CommandType.StoredProcedure,
                                    string fieldsToSkip = null, Dictionary<string, PropertyInfo> piList = null,
                                    params OracleParameter[] oracleParameters);
        /**--------------------------------------------------------------------------------------------------
        <summary> Executes the reader single operation. </summary>
        ...
        **/
        void EndTransaction(OracleTransaction oracleTransaction, bool transactionSucced = true, bool closeConnection = true);
    }
}
