...
namespace SimpleAccess.Repository
{
    ...
    public class SqlRepository : ISqlRepository, IDisposable
    {
        ...
        /// 
        /// <returns> . </returns>
        public TEntity FindSingle<TEntity>(SqlTransaction transaction, Expression<Func<TEntity, bool>> expression, string fieldToSkip = null)
            where TEntity : class, new()
        {
            var entityInfo = RepositorySetting.GetEntityInfo(typeof(TEntity));
        ...
        /// 
        /// <returns> . </returns>
        public IEnumerable<TEntity> Find<TEntity>(SqlTransaction transaction, Expression<Func<TEntity, bool>> expression, string fieldToSkip = null)
            where TEntity : class, new()
        {
            var entityInfo = RepositorySetting.GetEntityInfo(typeof(TEntity));
