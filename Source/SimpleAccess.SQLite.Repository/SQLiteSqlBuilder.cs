...
namespace SimpleAccess.SQLite
{
    ...
    public abstract class SQLiteSqlBuilder : ISqlBuilder<SQLiteParameter>
    {

        protected EntityParameters<SQLiteParameter> EntityInsertParameters { get; set; }
        protected EntityParameters<SQLiteParameter> EntityUpdateParameters { get; set; }
        ...
        public void InitSqlBuilder(IEntityInfo entityInfo)
        {
            ...
            EntityInfo = entityInfo;// as EntityInfo<SqlEntitiesSqlBuilder, SQLiteParameter>;
        ...
        /// </summary>
        /// <returns></returns>
        public EntityParameters<SQLiteParameter> CreateEntityParameters(bool createInsertParameter)
        {
            var entityParameters = EntityParameters<SQLiteParameter>.Create((dataParameters, outParamsDictionary, checkForIdentity) =>
            {
        ...
        /// <returns></returns>
        public void CreateDataParameter(PropertyInfo propertyInfo, IDictionary<PropertyInfo, SQLiteParameter> dataParameters
            , IDictionary<PropertyInfo, SQLiteParameter> outParamsDictionary, bool checkForIdentity)
        {
            ...
            if (outParaAttr != null)
            {
                throw new NotSupportedException("Output parameter are not supported in SQLite");
            ...
            Debug.WriteLine($"Parameter created: {sqlParam.ParameterName}" );
        ...
        ///// <returns></returns>
        //public IDataParameter[] CreateSQLiteParametersFromProperties(object entity)
        //{
        ...
        public EntityParameters<SQLiteParameter> GetInsertParameters(object entity)
        {
        ...
        public void FillInsertParameters(object entity, IDictionary<PropertyInfo, SQLiteParameter> parameters)
        {
            ...
            foreach (var dataParameter in parameters)
            {
                ...
                if ((propertyInfo.PropertyType.IsGenericType
                    || propertyInfo.PropertyType.Name == "String") & value == null)
                {
                    ((SQLiteParameter) sqlParam).IsNullable = true;
                    sqlParam.Value = DBNull.Value;
                    continue;
                }

                sqlParam.Value = value;
                Debug.WriteLine("Filling SQLiteParameter: {0}", sqlParam.ParameterName);
            }
        ...
        public EntityParameters<SQLiteParameter> GetUpdateParameters(object entity)
        {
        ...
        public string BuildWhereInClause<TEntity>(string propertyName, string @operator, object value, Expression<Func<TEntity, bool>> expression)
        {
            ...
            var subEntityInfo = SQLiteEntityRepositorySetting.GetEntityInfo(methodCallExp.Method.GetGenericArguments()[0]);
